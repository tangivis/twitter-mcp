...
- **このサーバーは何を?** ベンダリングした [twikit](https://github.com/d60/twikit) または XChat 用ローカルブラウザリーダーを使用する `@mcp.tool()` デコレータ付き async 関数を 62 個公開しています。LLM がユーザー意図 + ツール docstring から選択します。
